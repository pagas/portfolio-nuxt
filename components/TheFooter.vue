...
const links = [
    { name: 'GitHub', href: 'https://github.com/pagas', icon: 'entypo-social:github-with-circle' },
    ...
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/paulius-gaidamavicius/', icon: 'entypo-social:linkedin-with-circle' },
...
<template>
    <footer class="bg-gray-800">
        <section class="mx-auto max-w-7xl px-2 sm:px-4 lg:py-6 text-gray-300 flex flex-row">
            <p class="flex-1">&copy; Paulius 2023. All Rights Reserved</p>
